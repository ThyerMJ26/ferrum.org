...
export const definitions = [
    def("", ""),
    def("[]", "Tuple-brackets.", "An empty-tuple is also known as: no, nil, unit, an empty-list."),
    def("[ a ,, b ]", "A pair."),
    ...
    def("synthesized-type", "For compound terms, the type calculated for a term, based on its sub-terms.", "For term-variables, the type looked-up in the environment.", "For pattern-variables, the context-type is used.", "For literals, the singleton-type containing only that literal-value."),
...
//# sourceMappingURL=glossary-defs.js.map