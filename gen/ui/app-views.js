...
function collectRspObj(responses, rspObj) {
...
//     }
// }
export function ww_createTextView2(wui, args, viewCtx) {
...
//#region Editor
// --- Editor View ---
export function ww_createEditorView(wui, textSignal0, highlightSignal0) {
    const textSignal = textSignal0 ?? wui.x.state(null, "").rw();
    const highlightSignal = highlightSignal0 ?? wui.x.state(null, null).rw();
    return (viewCtx) => {
        const viewNum = viewCtx.viewNum;
        const rspObj = mkRspObj({
            init: [],
...
export function ww_createListView(wui, rowsSignal, selection, cb) {
    return (viewCtx) => {
        const viewNum = viewCtx.viewNum;
        const rspObj = mkRspObj({
            init: [],
...
//#region Table
// --- Table View ---
export function ww_createTableView(wui, viewCtx, headings, contents, selection, cb) {
    const rspObj = mkRspObj({
        init: [],
        setContents: [],
        selectRow: [],
...
export function ww_createPanelView(wui, name) {
    return (viewCtx) => {
        const viewNum = viewCtx.viewNum;
        ...
        class PanelViewImpl {
            ...
            addPane(paneName, defn, visibleToggle) {
                ...
                const visibleAnd = wui.x.compute(null, true, () => {
...
//#endregion
//#region Tabbed View
export function ww_createTabdedView(wui) {
    return (viewCtx) => {
        const viewNum = viewCtx.viewNum;
        const rspObj_init = mkRspObj({
            init: [],
        ...
        class TabbedViewImpl {
            ...
            addTab(tabName, defn, visibleToggle) {
                if (visibleToggle === undefined) {
