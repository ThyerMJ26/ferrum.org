...
import { addrNo, addrTypeType, assumeIsDirect, assumeIsType, depthInc, depthMax2, depthZero, false0 } from "../graph/graph-heap2.js";
import { tiIsTrue } from "../graph/graph-ti.js";
export function mkGraphApply(h, subst, predicates, tis) {
    ...
    function apply_funTy_argTy(depth, funTy, argTy0) {
        ...
        if (h.isTyFun(func)) {
            ...
            env.set(h.pathKey_root, argTm);
            const appTy2 = subst.substTmTy(depth, varDepth, env, domTy, cod);
            return appTy2;
        }
        if (h.isTyAny(func)) {
            // return tyAny
        ...
        if (h.isPrim("Self", func)) {
            ...
            if (h.isTmLam(self1Lam)) {
                ...
                const self2Fun = subst.substTmTy(appDepth, self1VarDepth, substEnv, argToVar, self1Body);
...
//# sourceMappingURL=graph-apply.js.map